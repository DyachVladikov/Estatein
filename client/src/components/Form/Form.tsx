...
const Form = (props: FormProps) => {
  ...
  const [formErrors, setformErrors] = useState<
    Partial<
      Record<
        keyof FormValues | "Privacy",
        { hasError: boolean; message: string }
      >
    >
  >({});
  const [activeCheckBox, setActiveCheckBox] = useState("phone-form-input");
  const [privacyCheckBoxIsChecked, setPrivacyCheckBoxIsChecked] =
    useState(false);
  ...
  return (
    ...
    >
      <fieldset disabled={isLocked ? true : false} style={{ padding: 0 }}>
            ...
            if (element.type === "input" && !element.doubleInput)
              return (
                <Input
                  ...
                  onChange={(el) => {
                    handlerChange(element.name, el);
                    formErrors[element.name] = { hasError: false, message: "" };
                  }}
                ...
                >
                  ...
                  <div className="input--double-wrapper">
                    <div
                      ...
                      id="phone-form-input"
                      onClick={(e) => handlerDoubleInput(e)}
                    >
                      <Icon
                        name="phone"
                        width="24px"
          ...
          <div className="form-textarea">
            ...
            <div className="form-textarea-wrapper">
              <textarea
                ...
                id="user-message"
                onChange={(e) =>
                  handlerChange("Message", e.currentTarget.value)
                }
              ></textarea>
            </div>
          </div>
            ...
            <div className="form-send__privacy">
              <input
                ...
                className={classNames(
                  "form-send__privacy-checkbox",
                  { "is-checked": privacyCheckBoxIsChecked },
                  { "is-unchecked": formErrors.Privacy?.hasError },
                )}
                type="checkbox"
                onClick={() => {
                  setPrivacyCheckBoxIsChecked((prev) => !prev);
                  formErrors.Privacy = { hasError: false, message: "" };
                }}
              />
              <label

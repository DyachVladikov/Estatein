...
const Header = () => {    
   ...
   const Links = [
    ...
    const navigation = <nav className={classNames("header__navigation", {"hidden-mobile" : !isModalOpen})}>
    ...
    return (
        <>
            <LearnMore />
            <header ref={stickyRef} className={classNames("header container", {"sticky" : isStuck })}>
                <Logo />
                {navigation}
                <Link to={"/contact-us"} className="header__button-contact-us-link hidden-mobile">

  ...
  const SelectProperties = [
    {
      ...
      items: {
        ...
        items: ["Malibu", "Napa", "Santa Barbara", "Palm Springs", "None"],
      },
    ...
    },
    {
      ...
      items: {
        type: "strings" as const,
        items: ["Estate", "Beach House", "Villa", "Penthouse", "None"],
      },
      name: "type-filter",
    },
    {
    ...
    <section className="search container">
      <div className="search-wrapper">
        <div className="search__inside">
          <input
            id="search__inside-input"
            className="search__inside-input"
          ...
          />
          <Button
            className="search__inside-button hidden-mobile"
            title="Find Property"
            label="Find Property"
            hasIconBefore={true}
            iconName="search"
          ...
          />
          <Button
            className="search__inside-button-mobile visible-mobile"
            title="Find Property"
            iconName="search"
            mode="purple"
            hasOnlyIcon
      ...
      <ul className="search__filters-list">
        {SelectProperties.map((propeties) => (
          <li
            className="search__filters-item"
            key={`${propeties.placeholder}-filter`}
          >
            <Select
              {...propeties}
              mode="blackWithIcon"
